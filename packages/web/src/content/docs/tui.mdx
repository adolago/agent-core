---
title: TUI
description: Using the Agent-Core terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Agent-Core provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Agent-Core starts the TUI for the current directory.
...
When using the Agent-Core TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Agent-Core. Allows you to select from available providers and add their API keys.
...
Exit Agent-Core. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Agent-Core config file.
