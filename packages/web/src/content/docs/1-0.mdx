...
description: What's new in Agent-Core 1.0.
---

Agent-Core 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same agent-core server.
...
version. However some older versions of Agent-Core always grab latest.

To upgrade manually, run

```bash
$ agent-core upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ agent-core upgrade 0.15.31
```
