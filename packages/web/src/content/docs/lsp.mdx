---
title: LSP Servers
description: Agent-Core integrates with your LSP servers.
---

Agent-Core integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Agent-Core comes with several built-in LSP servers for popular languages:
...
When agent-core opens a file, it:
...
You can customize LSP servers through the `lsp` section in your agent-core config.
