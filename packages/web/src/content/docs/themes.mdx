...
With Agent-Core you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Agent-Core uses our own `agent-core` theme.
...
Agent-Core comes with several built-in themes.
...
- Want Agent-Core to match their terminal's appearance
...
Agent-Core supports a flexible JSON-based theme system that allows users to create and customize themes easily.
