export namespace Flag {
  ...
  export const AGENT_CORE_SERVER_PASSWORD = process.env["AGENT_CORE_SERVER_PASSWORD"]
  export const AGENT_CORE_SERVER_USERNAME = process.env["AGENT_CORE_SERVER_USERNAME"]
  export const OPENCODE_SERVER_PASSWORD = process.env["OPENCODE_SERVER_PASSWORD"]
  export const OPENCODE_SERVER_USERNAME = process.env["OPENCODE_SERVER_USERNAME"]
  export const AGENT_CORE_DISABLE_SERVER_AUTH = truthy("AGENT_CORE_DISABLE_SERVER_AUTH")
  export const OPENCODE_DISABLE_SERVER_AUTH = truthy("OPENCODE_DISABLE_SERVER_AUTH")
  ...
  export const OPENCODE_EXPERIMENTAL_LLM_STREAM_START_TIMEOUT_MS = number(
    "OPENCODE_EXPERIMENTAL_LLM_STREAM_START_TIMEOUT_MS",
  )
