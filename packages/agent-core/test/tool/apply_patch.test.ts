  ...
  test("applies add/update/delete in one patch", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(permissionCall.metadata.filepath).toContain("nested/new.txt")
        expect(permissionCall.metadata.filepath).toContain("modify.txt")
        expect(permissionCall.metadata.filepath).toContain("delete.txt")
