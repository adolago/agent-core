...
describe("OpenCode Zen Claude Extended Thinking", () => {
  const sessionID = "test-session"

  test("Claude via OpenCode Zen gets thinking enabled", () => {
    const model = createMockModel({
  ...
  test("Claude Sonnet via OpenCode Zen gets thinking enabled", () => {
    const model = createMockModel({
  ...
  test("Claude Haiku via OpenCode Zen gets thinking enabled", () => {
    const model = createMockModel({
  ...
  test("OpenCode Zen non-Claude models do not get thinking", () => {
    const model = createMockModel({
      id: "opencode/gpt-5.2",
      providerID: "opencode",
      api: {
    ...
    const result = ProviderTransform.options({ model, sessionID, providerOptions: {} })
    // GPT models don't contain "claude", "kimi-k2-thinking", or "glm-4"
    expect(result.thinking).toBeUndefined()
  })
})

describe("OpenCode Zen Kimi K2 Thinking", () => {
  const sessionID = "test-session"

  test("Kimi K2 Thinking via OpenCode gets thinking enabled", () => {
    const model = createMockModel({
  ...
  test("Kimi K2 (non-thinking) does NOT get thinking enabled", () => {
    const model = createMockModel({
      id: "opencode/kimi-k2",
      providerID: "opencode",
      api: {
    ...
    const result = ProviderTransform.options({ model, sessionID, providerOptions: {} })
    // kimi-k2 without "thinking" should NOT match the condition
    expect(result.thinking).toBeUndefined()
  })
})

describe("OpenCode Zen GLM-4 Thinking", () => {
  const sessionID = "test-session"

  test("GLM-4 via OpenCode gets thinking enabled", () => {
    const model = createMockModel({
  ...
  test("GLM-4.7 via OpenCode gets thinking enabled", () => {
    const model = createMockModel({
      id: "opencode/glm-4.7",
      providerID: "opencode",
      api: {
