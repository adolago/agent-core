...
function mergeSlackAccountConfig(cfg: ZeeConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ZeeConfig): ResolvedSlackAccount[] {
