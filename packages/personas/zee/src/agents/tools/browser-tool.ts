...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    name: "browser",
    description:
      "Control zee's dedicated browser (status/start/stop/tabs/open/snapshot/screenshot/actions). Use snapshot+act for UI automation. Avoid act:wait by default; use only in exceptional cases when no reliable UI state exists.",
