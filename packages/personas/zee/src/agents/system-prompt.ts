...
import type { EmbeddedContextFile } from "./agent-helpers.js";
...
export function buildAgentSystemPrompt(params: {
  ...
  const toolSummaries: Record<string, string> = {
    ...
    gateway: "Restart, apply config, or run updates on the zee-powered process",
  ...
  const lines = [
    ...
    "These user-editable files are loaded by zee (or delegated persona) and included below in Project Context.",
    "",
