...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    "## Documentation",
    `Zee docs: ${docsPath}`,
    "Mirror: https://docs.zee.bot",
    "Source: https://github.com/zee/zee",
    "Community: https://discord.com/invite/zee",
    "Find new skills: https://zeehub.com",
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "- zee gateway stop",
    "- zee gateway restart",
    "If unsure, ask the user to run `zee.*gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
