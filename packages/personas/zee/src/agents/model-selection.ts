...
import type { ModelCatalogEntry } from "./llm-types.js";
...
export function resolveConfiguredModelRef(params: {
  ...
  if (rawModel) {
    ...
    // Legacy fallback: if model string doesn't resolve, assume it's an Anthropic model name.
    // This supports old configs that specify just "claude-3-opus" without "anthropic:" prefix.
    // Remove once all configs are migrated to explicit provider:model format.
