...
vi.mock("../agents/llm-types.js", async () => {
  const actual = await vi.importActual<typeof import("../agents/llm-types.js")>(
    "../agents/llm-types.js",
  );
...
vi.mock("../agents/agent-core-embedded.js", async () => {
  const actual = await vi.importActual<
    typeof import("../agents/agent-core-embedded.js")
  >("../agents/agent-core-embedded.js");
  return {
    ...actual,
...
vi.mock("../web/outbound.js", () => ({
  ...
  sendPollWhatsApp: vi
    .fn()
    .mockResolvedValue({ messageId: "poll-1", toJid: "jid-1" }),
}));
