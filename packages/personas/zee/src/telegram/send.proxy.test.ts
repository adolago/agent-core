...
describe("telegram proxy client", () => {
  ...
  beforeEach(() => {
    ...
    vi.resetModules();
    return import("./send.js").then((mod) => {
      sendMessageTelegram = mod.sendMessageTelegram;
      reactMessageTelegram = mod.reactMessageTelegram;
      deleteMessageTelegram = mod.deleteMessageTelegram;
    });
  });
