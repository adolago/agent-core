...
export const GATEWAY_LAUNCH_AGENT_LABEL = "com.zee.gateway";
...
export const NODE_LAUNCH_AGENT_LABEL = "com.zee.node";
...
export const LEGACY_GATEWAY_LAUNCH_AGENT_LABELS = ["com.steipete.zee.gateway"];
