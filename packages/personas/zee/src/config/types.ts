// =============================================================================
// Shared Primitives (synced from agent-core)
// =============================================================================

// Import shared types for local use
import type {
  BindMode as SharedBindMode,
  DmPolicy as SharedDmPolicy,
  GroupPolicy as SharedGroupPolicy,
  LogLevel as SharedLogLevel,
  MessagingProvider as SharedMessagingProvider,
  ReplyMode as SharedReplyMode,
  ReplyToMode as SharedReplyToMode,
  RetryConfig as SharedRetryConfig,
  SessionChatType as SharedSessionChatType,
  SessionScope as SharedSessionScope,
  ThinkingLevel as SharedThinkingLevel,
  TypingMode as SharedTypingMode,
} from "./shared-primitives.js";

// Re-export with original names for backward compatibility
export type ReplyMode = SharedReplyMode;
export type TypingMode = SharedTypingMode;
export type SessionScope = SharedSessionScope;
export type ReplyToMode = SharedReplyToMode;
export type GroupPolicy = SharedGroupPolicy;
export type DmPolicy = SharedDmPolicy;

// Export new shared types
export type { SharedLogLevel as LogLevel };
export type { SharedSessionChatType as SessionChatType };
export type { SharedMessagingProvider as MessagingProvider };
export type { SharedThinkingLevel as ThinkingLevel };
export type { SharedBindMode as BindMode };

// =============================================================================
// Zee-specific Types (extend shared primitives)
// =============================================================================

/** @deprecated Use RetryConfig from shared-primitives */
export type OutboundRetryConfig = SharedRetryConfig;
...
export type BrowserConfig = {
  ...
  attachOnly?: boolean;
  /** Default profile to use when profile param is omitted. Default: "zee" */
...
/** Telegram user account configuration (using phone number auth instead of bot token). */
export type TelegramUserConfig = {
  /** If true, enable user mode with phone number authentication. */
  enabled?: boolean;
  /** Phone number for Telegram user authentication. */
  phoneNumber?: string;
...
export type TelegramConfig = {
  ...
  /** Optional Telegram user account configuration (phone number auth). */
...
export type SlackSlashCommandConfig = {
  ...
  enabled?: boolean;
  /** Slash command name (default: "zee"). */
  name?: string;
