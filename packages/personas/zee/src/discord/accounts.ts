...
function mergeDiscordAccountConfig(cfg: ZeeConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: ZeeConfig): ResolvedDiscordAccount[] {
