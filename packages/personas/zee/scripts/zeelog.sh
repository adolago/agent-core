...
show_usage() {
    cat << EOF
clawlog - Zeebot Logging Utility

USAGE:
    vtlog [OPTIONS]

DESCRIPTION:
    View Zeebot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Zeebot logs flow through the macOS unified log (subsystem: com.zeebot).
