...
# Output:
# - dist/Zee.app
# - dist/Zee-<version>.zip
# - dist/Zee-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Zee-$VERSION.zip"
DMG="$ROOT_DIR/dist/Zee-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Zee-$VERSION.notary.zip"
