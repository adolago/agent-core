...
SMOKE_IMAGE="${CLAWDBOT_INSTALL_SMOKE_IMAGE:-zee-install-smoke:local}"
NONROOT_IMAGE="${CLAWDBOT_INSTALL_NONROOT_IMAGE:-zee-install-nonroot:local}"
INSTALL_URL="${CLAWDBOT_INSTALL_URL:-https://docs.zee/install.sh}"
CLI_INSTALL_URL="${CLAWDBOT_INSTALL_CLI_URL:-https://docs.zee/install-cli.sh}"
