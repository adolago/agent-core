...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "bot.zee", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ZeePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ZeePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
