...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "bot.zee", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".zee/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.zeeCommand(
            subcommand: "gateway",
