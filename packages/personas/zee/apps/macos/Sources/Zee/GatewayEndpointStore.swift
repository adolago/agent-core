...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "bot.zee", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "bot.zee", category: "gateway-endpoint")
