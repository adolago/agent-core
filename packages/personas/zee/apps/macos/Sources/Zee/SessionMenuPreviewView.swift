...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "bot.zee", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> ZeeSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: ZeeSessionPreviewEntry,
    ...
    private static func cache(payload: ZeeSessionsPreviewPayload, maxItems: Int) async {
