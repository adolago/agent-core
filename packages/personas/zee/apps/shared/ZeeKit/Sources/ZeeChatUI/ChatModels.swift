...
public struct ZeeSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ZeeSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ZeeSessionPreviewItem]
}

public struct ZeeSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ZeeSessionPreviewEntry]

    public init(ts: Int, previews: [ZeeSessionPreviewEntry]) {
        self.ts = ts
