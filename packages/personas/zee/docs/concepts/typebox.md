...
- **TypeBox → Swift**: `pnpm protocol:gen:swift` generates [`apps/shared/ZeeKit/Sources/ZeeProtocol/GatewayModels.swift`](https://github.com/zee/zee/blob/main/apps/shared/ZeeKit/Sources/ZeeProtocol/GatewayModels.swift).
