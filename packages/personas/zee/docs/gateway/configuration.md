...
credential is a setup-token. Zee auto-migrates older configs that used
`mode: "token"`.
...
Zee can start a **dedicated, isolated** Chrome/Brave/Edge/Chromium instance for zee and expose a small loopback control server.
