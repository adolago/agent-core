...
read_when:
  - Setting up Zalo Personal for Zee
...
- Install via CLI: `zee plugins install @zee/zalouser`
- Or from a source checkout: `zee plugins install ./extensions/zalouser`
...
Approve via:
- `zee pairing list zalouser`
- `zee pairing approve zalouser <code>`
...
- On startup, Zee resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `zee channels logout --channel zalouser && zee channels login --channel zalouser`
