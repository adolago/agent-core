...
### `docs.zee.bot` shows an SSL error (Comcast/Xfinity)

Some Comcast/Xfinity connections block `docs.zee.bot` via Xfinity Advanced Security.
Disable Advanced Security or add `docs.zee.bot` to the allowlist, then retry.
