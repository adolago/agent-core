...
export default function Home() {
  ...
  return (
    <main data-page="agent-core">
      {/*<HttpHeader name="Cache-Control" value="public, max-age=1, s-maxage=3600, stale-while-revalidate=86400" />*/}
      <Title>Agent-Core | The open source AI coding agent</Title>
        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">INSTALL_URL</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">agent-core</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/agent-core</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is Agent-Core?</h3>
              <p>Agent-Core is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, Agent-Core is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  Agent-Core does not store any of your code or context data, so that it can operate in privacy sensitive
            ...
            <ul>
              <li>
                <Faq question="What is Agent-Core?">
                  Agent-Core is an open source agent that helps you write and run code with any AI model. It's available
              ...
              <li>
                <Faq question="Do I need extra AI subscriptions to use Agent-Core?">
                  Not necessarily, Agent-Core comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, Agent-Core also works with all
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with Agent-Core?">
                  Yes, Agent-Core supports subscription plans from all major providers. You can use your Claude Pro/Max,
              ...
              <li>
                <Faq question="How much does Agent-Core cost?">
                  Agent-Core is 100% free to use. It also comes with a set of free models. There might be additional costs
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that Agent-Core has tested and benchmarked
