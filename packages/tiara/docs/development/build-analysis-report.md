...
This project has **CRITICAL BUILD FAILURES** that prevent compilation. There are 7,739 total issues (1,111 errors, 6,628 warnings) that must be systematically addressed to achieve a clean build.
...
*This analysis covers 7,739 total issues across 322 TypeScript files in this project. The systematic approach ensures a stable, maintainable codebase while minimizing risk of introducing new issues.*