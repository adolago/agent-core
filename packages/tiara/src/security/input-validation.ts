 ...
 *
 * @module tiara/security/input-validation
 */
...
/**
 * Validation options for string input
 */
 ...
 * @returns Validation result
 */
export function validatePath(path: string, allowedBase?: string): ValidationResult<string> {
