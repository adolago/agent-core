    ...
    try {
      ...
      try {
        ...
        const memoryConfig: MemoryConfig = {
          ...
          retentionDays: 30,
          url: process.env.MEMORY_QDRANT_URL || process.env.QDRANT_URL || 'http://localhost:6333',
          collection:
            process.env.MEMORY_QDRANT_COLLECTION ||
            process.env.QDRANT_COLLECTION_MEMORY ||
            'agent_memory',
        };
        ...
        this.updateComponentStatus('memory', 'healthy', 'Memory manager initialized with Qdrant');
