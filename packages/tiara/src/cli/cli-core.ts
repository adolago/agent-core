#!/usr/bin/env node
/**
 * Tiara CLI - Core implementation using Node.js
 */
...
let verbosityLevel: VerbosityLevel = 'normal';
...
function setVerbosity(level: VerbosityLevel): void {
  verbosityLevel = level;
}

// Export for use in other modules
export { CLI, success, error, warning, info, debug, setVerbosity };
