...
import { QdrantPersistenceManager } from './qdrant-persistence.js';
...
export class Orchestrator {
  ...
  private persistence: QdrantPersistenceManager;
  ...
  constructor(
    ...
    const memoryConfig = this.config.get()?.memory;
    this.persistence = new QdrantPersistenceManager({
