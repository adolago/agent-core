...
describe('Helpers', () => {
  ...
  describe('retry', () => {
    ...
    it('should call onRetry callback', async () => {
      ...
      expect(onRetry).toHaveBeenCalledWith(1, expect.any(Error)); // attempt number and error
    });
  ...
  describe('greeting', () => {
    ...
    it('should include name', () => {
      expect(greeting('Bolt')).toContain('Bolt');
    });

    it('should respect time of day', () => {
      // Mock Date
      const originalDate = global.Date;
      const mockDate = new Date('2023-01-01T10:00:00'); // Morning
      ...
      expect(greeting('Bolt', { timeOfDay: true })).toContain('Good morning');

      global.Date = originalDate;
    });

    it('should use locale', () => {
      expect(greeting('Bolt', { locale: 'es' })).toContain('Hola');
      expect(greeting('Bolt', { locale: 'fr', formal: true })).toContain('Bonjour');
    });
  });
});