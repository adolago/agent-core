...
export function createSurface(
  type: 'cli' | 'gui' | 'whatsapp' | 'telegram' | 'discord',
  ...
  switch (type) {
    ...
    case 'whatsapp':
      return createWhatsAppSurface(config);
    case 'telegram':
      return createTelegramSurface(config);
    case 'discord':
      return createDiscordSurface(config);
    default:
