...
| SSE stream parsing (code exists) | Partial | Not connected to UI |
| Prompt input component | Partial | Basic text input, no features |
...
|  API (client.rs)                                          |
|  - HTTP methods (done)                                    |
|  - SSE parsing (done but NOT CONNECTED)                  |
